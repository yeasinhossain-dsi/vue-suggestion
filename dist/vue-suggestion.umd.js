(function (global, factory) {
	...
	var script$1 = {
	  ...
	  methods: {
	    ...
	    blur: function blur() {
	      ...
	      this.searchText = ''; // set timeout for the click event to work
	...
	exports.VueSuggestion = __vue_component__$1;
